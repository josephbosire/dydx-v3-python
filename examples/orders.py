...
async def main():
    ...
    # Get our position ID.
    account_response = await client.private.get_account()
    ...
    order_response = await client.private.create_order(**order_params)
    ...
    for replace_price in range(21, 26):
        order_response = await client.private.create_order(
            **dict(
                order_params,
    ...
    orders_response = await client.private.get_orders(
        market=MARKET_BTC_USD,
